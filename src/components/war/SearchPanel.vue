...
<script lang="ts">
import { GameDune, GameDuneStatistics, PersonData, People, } from '@/models/models';
...
export default defineComponent({
  ...
  mounted() {
    ...
    this.peopleData[personIndex].data = GameDuneStatistics.getPersonStatistics( this.allGames, this.peopleData[personIndex].person );
